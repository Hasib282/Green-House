...
{
    public partial class Indoor4 : Form
    {
        Indoor I;
        Indoor2 I2;
        Indoor3 I3;
        ...
        private void panel1_Paint(object sender, PaintEventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("select Name,Price from Product where PID=19", con);
            ...
            try
            {
                SqlConnection con = new SqlConnection("Data Source=DESKTOP-QLO3OM5;Initial Catalog=GreenHouse;Persist Security Info=True;User ID=Hasib;Password=Hasib282");
                con.Open();
                SqlCommand cmd = new SqlCommand("select Name,Price from Product where PID=20", con);
                SqlDataReader dr = cmd.ExecuteReader();
                while (dr.Read())
                {
            ...
            try
            {
                SqlConnection con = new SqlConnection("Data Source=DESKTOP-QLO3OM5;Initial Catalog=GreenHouse;Persist Security Info=True;User ID=Hasib;Password=Hasib282");
                con.Open();
                SqlCommand cmd = new SqlCommand("select Name,Price from Product where PID=21", con);
                SqlDataReader dr = cmd.ExecuteReader();
                while (dr.Read())
                {
            ...
            try
            {
                SqlConnection con = new SqlConnection("Data Source=DESKTOP-QLO3OM5;Initial Catalog=GreenHouse;Persist Security Info=True;User ID=Hasib;Password=Hasib282");
                con.Open();
                SqlCommand cmd = new SqlCommand("select Name,Price from Product where PID=22", con);
                SqlDataReader dr = cmd.ExecuteReader();
                while (dr.Read())
                {
            ...
            try
            {
                SqlConnection con = new SqlConnection("Data Source=DESKTOP-QLO3OM5;Initial Catalog=GreenHouse;Persist Security Info=True;User ID=Hasib;Password=Hasib282");
                con.Open();
                SqlCommand cmd = new SqlCommand("select Name,Price from Product where PID=23", con);
                SqlDataReader dr = cmd.ExecuteReader();
                while (dr.Read())
                {
            ...
            try
            {
                SqlConnection con = new SqlConnection("Data Source=DESKTOP-QLO3OM5;Initial Catalog=GreenHouse;Persist Security Info=True;User ID=Hasib;Password=Hasib282");
                con.Open();
                SqlCommand cmd = new SqlCommand("select Name,Price from Product where PID=24", con);
                SqlDataReader dr = cmd.ExecuteReader();
                while (dr.Read())
                {
        ...
        private void Indoor4_Load(object sender, EventArgs e)
        {
            try
            {
                SqlConnection con = new SqlConnection("Data Source=DESKTOP-QLO3OM5;Initial Catalog=GreenHouse;Persist Security Info=True;User ID=Hasib;Password=Hasib282");
