...
{
    public partial class Outdoor6 : Form
    {
        GreenHouse G;
        EditProfile E;
        Customer Ca;
        ...
        private void panel1_Paint(object sender, PaintEventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("select Name,Price from Product where PID=73", con);
            ...
            try
            {
                SqlConnection con = new SqlConnection("Data Source=DESKTOP-QLO3OM5;Initial Catalog=GreenHouse;Persist Security Info=True;User ID=Hasib;Password=Hasib282");
                con.Open();
                SqlCommand cmd = new SqlCommand("select Name,Price from Product where PID=74", con);
                SqlDataReader dr = cmd.ExecuteReader();
                while (dr.Read())
                {
            ...
            try
            {
                SqlConnection con = new SqlConnection("Data Source=DESKTOP-QLO3OM5;Initial Catalog=GreenHouse;Persist Security Info=True;User ID=Hasib;Password=Hasib282");
                con.Open();
                SqlCommand cmd = new SqlCommand("select Name,Price from Product where PID=75", con);
                SqlDataReader dr = cmd.ExecuteReader();
                while (dr.Read())
                {
            ...
            try
            {
                SqlConnection con = new SqlConnection("Data Source=DESKTOP-QLO3OM5;Initial Catalog=GreenHouse;Persist Security Info=True;User ID=Hasib;Password=Hasib282");
                con.Open();
                SqlCommand cmd = new SqlCommand("select Name,Price from Product where PID=76", con);
                SqlDataReader dr = cmd.ExecuteReader();
                while (dr.Read())
                {
            ...
            try
            {
                SqlConnection con = new SqlConnection("Data Source=DESKTOP-QLO3OM5;Initial Catalog=GreenHouse;Persist Security Info=True;User ID=Hasib;Password=Hasib282");
                con.Open();
                SqlCommand cmd = new SqlCommand("select Name,Price from Product where PID=77", con);
                SqlDataReader dr = cmd.ExecuteReader();
                while (dr.Read())
                {
            ...
            try
            {
                SqlConnection con = new SqlConnection("Data Source=DESKTOP-QLO3OM5;Initial Catalog=GreenHouse;Persist Security Info=True;User ID=Hasib;Password=Hasib282");
                con.Open();
                SqlCommand cmd = new SqlCommand("select Name,Price from Product where PID=78", con);
                SqlDataReader dr = cmd.ExecuteReader();
                while (dr.Read())
                {
        ...
        private void Outdoor6_Load(object sender, EventArgs e)
        {
            try
            {
                SqlConnection con = new SqlConnection("Data Source=DESKTOP-QLO3OM5;Initial Catalog=GreenHouse;Persist Security Info=True;User ID=Hasib;Password=Hasib282");
